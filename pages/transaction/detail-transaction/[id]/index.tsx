...
import { sampleTransactionPaymentDetail } from '@/utils'
...
//             <ModalTransaction tran_id={tran_id} creator={transaction.post.createUser} userId={transaction.post.userId}/>
//             <Container>
...
//                                 <TransactionDetail
//                                     id={tran_id}
//                                     slotCount={transaction.slotCount}
//                                     slots={transaction.slots}
//                                     buyerName={transaction.buyerName}
//                                     payTime={transaction.payTime}
//                                     post={transaction.post}
//                                     cancelHour={transaction.cancelHour}
//                                 />
//                                 <TransactionExtra
//                                     id={tran_id}
...
const TransactionDetailPage = () => {
    ...
    const transaction = sampleTransactionPaymentDetail.data.find(transaction => transaction.id === id);
