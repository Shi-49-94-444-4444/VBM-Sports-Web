...
import { sampleListProducts } from '@/utils';
...
const DetailBadmintonPage = () => {
    ...
    const product = sampleListProducts.data.find(product => product.id === id);
    ...
    return (
        <Layout>
            ...
            <ModalFailPayment />
            <ModalSuccessPayment />
            <ModalReportPost id={id as string} />
            <Container>
                <ProductContent
                    id={id as string}
                ...
                <ProductUserPost
                    ...
                    userId={product.userId}
                />
                <ProductOtherExtra id={id as string}/>
            </Container>
        </Layout>
    )
}
