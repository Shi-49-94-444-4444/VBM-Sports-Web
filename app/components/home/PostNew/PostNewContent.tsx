                ...
                <div key={listItem[0].id} className="col-span-1">
                    ...
                    >
                        ...
                        <div className="absolute bottom-2 left-4 text-white">
                            <h1 className="text-sm">{listItem[0].date}</h1>
                            <p className="text-lg font-semibold">{listItem[0].title}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-rows-2 gap-3">
                        <div key={listItem[1].id} className="row-span-1">
                            ...
                            >
                                ...
                                <div className="absolute bottom-2 left-4 text-white">
                                    <h1 className="text-sm">{listItem[1].date}</h1>
                                    <p className="text-lg font-semibold">{listItem[1].title}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div key={listItem[2].id} className="col-span-1">
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-2 left-4 text-white">
                                            <h1 className="text-sm">{listItem[3].date}</h1>
                                            <p className="text-lg font-semibold">{listItem[1].title}</p>
                                        </div>
                                    </div>
                                </div>
                                <div key={listItem[3].id} className="col-span-1">
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-2 left-4 text-white">
                                            <h1 className="text-sm">{listItem[3].date}</h1>
                                            <p className="text-lg font-semibold">{listItem[3].title}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
